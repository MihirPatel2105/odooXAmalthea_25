...
const ExpensesList = () => {
  ...
  // Calculate summary totals safely
  const summaryTotals = Array.isArray(summary) ? summary.reduce((acc, item) => {
        ...
        <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
          ...
          {summary.map((item) => (
            <div key={item._id} className="card text-center">
              ...
              <p className="text-xl font-semibold text-gray-900">{item.count || 0}</p>
